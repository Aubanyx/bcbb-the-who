 ...
 <div class="card-body">
   <form class="p-5">
     ...
     <div class="border rounded validate-input mt-2" data-validate="Type first name">
                 <input class="input100 border-0 form-control-plaintext p-3" type="text" placeholder="First name">
                 <span class="focus-input100"></span>
     </div>

     <div class="border rounded validate-input mt-2" data-validate="Type last name">
                 <input class="input100 border-0 form-control-plaintext p-3" type="text" placeholder="Last name">
                 <span class="focus-input100"></span>
     </div>
     ...
     <label class="w-100 mt-4 text-secondary" for="email"><h5>Enter your email</h5></label>
             <div class="border rounded validate-input mt-2" data-validate = "Valid email is required: ex@abc.xyz">
                 <input id="email" class="input100 border-0 form-control-plaintext p-3"" type="text" name="email" placeholder="Eg. example@email.com">
                 <span class="focus-input100"></span>
             </div>        
     ...
     <div class="form-check mt-4">
       ...
       <label class="form-check-label text-secondary pl-3 pt-1" for="defaultCheck1">
         I agree with the to the Board <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a>.
       </label>
     </div>

     <button class="btn text-white font-weight-bold btn-block my-4 border-0 rounded rounded-pill board-util__btn" type="submit">Sign in</button>
