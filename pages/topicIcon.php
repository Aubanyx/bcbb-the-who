...
<div class="container overlay position-relative shadow-sm rounded-lg bg-white pb-5">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent pt-5">
            <li class="breadcrumb-item"><a href="http://localhost:8888/"><i class="fas fa-home"></i> Home</a></li>
            <li class="breadcrumb-item" aria-current="page"><a href="http://localhost:8888/">Board Index</a></li>
            <li class="breadcrumb-item" aria-current="page"><a href="http://localhost:8888/">Category One</a></li>
                    ...
                    <div class="card-body bg-light">
                        <div class="forumslist shadow-sm bg-white mt-1 p-3">
                            <div class="row no-gutters text-black-50 align-items-center">
                                ...
                                <div class="col"><a href="http://localhost/bcbb-the-who/pages/topicRead.php#">This is an
                                        announcement!</a>
                    ...
                    <div class="card-body bg-light">
                        <div class="forumslist shadow-sm bg-white mt-1 p-3">
                            ...
                            <div class="row no-gutters py-3 text-black-50 align-items-center">
                                ...
                                <div class="col"><a href="http://localhost/bcbb-the-who/pages/topicread.php">Won't Get
                                        Fooled Again</a>
                                ...
                                <div class="d-none d-md-block col-6">
                                    <div class="row no-gutters pl-2 align-items-center">
                                        ...
                                        <div class="media col-6 align-items-center">
                                            <p>by <a href="#"">Sandrine</a> <a href="#"><i
                                                            class="fas fa-external-link-alt"></i></a>
                            ...
                            <div class="row no-gutters py-3 text-black-50 align-items-center">
                                <div class="col-1 text-center"><i class="fas fa-check forumslist__green"></i></div>
                                <div class="col"><a href="http://localhost/bcbb-the-who/topicread.php">Who Are You</a>
                    ...
                    <div id="demo" class="collapse show" data-parent="#accordionGroup">
                        <div class="card-body">
                            <form>
                                ...
                                <div class="form-group">
                                    <button type="submit"
                                            class="btn text-white btn-login btn-block rounded rounded-pill"> Login
                                    </button>
                                </div> <!-- form-group// -->
                            </form>
                ...
                <div class="card mt-5 border-0 height-5">
                    ...
                    <div class="card-body bg-light last-posts">
                        <div class="last-posts__desc">
                            <div class="card-text rounded bg-white mt-3 p-3"><h5>Post - category 3 <span
                                            class="float-right font-weight-normal"> 2 hours ago</span></h5>
                ...
                <div class="card mt-5 border-0">
                    ...
                    <div class="card-body bg-light last-users">
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="card rounded border-0 w-100 m-1 pd-1">
                                <div class="card-body text-center">
                                    <img src="https://www.flaticon.com/svg/static/icons/svg/3011/3011288.svg"
                                         alt="profile-image">
                            ...
                            <div class="card rounded border-0 w-100 m-1 pd-1">
                                <div class="card-body text-center">
                                    <img src="https://www.flaticon.com/svg/static/icons/svg/3011/3011289.svg"
                                         alt="profile-image">
                ...
                <div id="accordion" role="tablist">
                    <div class="card border-0 mt-5">
                        <div class="grad" role="tab" id="headingOne">
                            <h5 class="mb-0">
                                <button type="button"
                                        class="btn m-0 p-0 bg-transparent text-left font-weight-bold text-white btn-block accordion-btn"
                                        data-toggle="collapse" data-target="#blankwidget"><h4
                                            class="font-weight-normal">Blank widget</h4></button>
                        ...
                        <div id="blankwidget" class="collapse" data-parent="#accordion" role="tabpanel"
                            ...
                            <div class="card-body bg-light">
                                <div class="forumslist shadow-sm bg-white mt-1 p-3">
                                    <p><a href="https://www.youtube.com/watch?v=x2KRpRMSu4g&list=PLB2359E68D19BA3C0">The
                                            Who Playlist</a></p>
