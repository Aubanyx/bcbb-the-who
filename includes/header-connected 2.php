    ...
    <nav class="navbar navbar-expand-lg navbar-light justify-content-end p-5">
        <div class="" id="navbarNavAltMarkup">
            <div class=" h4 navbar-nav">
                <a class="nav-item nav-link text-light mx-3" href="http://localhost/bcbb-the-who/index.php#"><i
                            class="fas fa-home"></i> Home</a>
                <a class="nav-item nav-link text-light mx-3" href="http://localhost/bcbb-the-who/index.php#"><i
                            class="fas fa-search"></i> Search</a>
                <a class="nav-item nav-link text-light mx-3" href="http://localhost/bcbb-the-who/index.php#"><i
                            class="fas fa-users"></i> Members</a>
                <a class="nav-item nav-link active text-light mx-3" href="http://localhost/bcbb-the-who/index.php#"><i
